...
public class TodoController {
    ...
    @GetMapping("/get")
    public @ResponseBody ResponseEntity<List<Todo>> findall() {
    ...
    public @ResponseBody ResponseEntity<?> getById(@PathVariable Long todoId) {
        ...
        Todo todo = todoService.findOne1(todoId);
